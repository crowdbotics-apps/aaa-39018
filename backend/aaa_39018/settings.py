"""
Django settings for aaa_39018 project.
...
WSGI_APPLICATION = 'aaa_39018.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aaa_39018 API",
    "DESCRIPTION": "API documentation for aaa_39018 App",
    "VERSION": "v1",
}
